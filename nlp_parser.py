...
SKILL_KEYWORDS = [ "python","java","c++","r","sql","javascript","c", "deluge","go"
                    "pandas", "numpy", "scikit-learn","matplotlib","seaborn","excel"
                    "tableau","power bi", "machine learning","deep learning","nlp","tensorflow","keras","computer vision",
                    "jupyter","googlecolab","vscode","colab","mysql","mongodb","postgresql","aws","azure","docker","git"]
...
def extract_experience(text):
    experience_titles = []
    start_keywords = ["project experiences", "projects", "experience", "work experience", "internship"]
    ...
    for line in lines:
        ...
        if re.match(r"^\d+\.\s*", clean): 
            ...
            experience_titles.append(clean)
    return experience_titles if experience_titles else None
